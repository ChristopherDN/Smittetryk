...
public class CountyRESTController {
    ...
    public ResponseEntity<County> updateCounty(@PathVariable String id, @RequestBody County county) {
        ...
        if (optCounty.isPresent()) {
            ...
            County notFountCounty = new County();
            notFountCounty.setName("Jeg kunne ikke finde id=" + id);
            return new ResponseEntity<County>(notFountCounty, HttpStatus.NOT_FOUND);
        }
    }
    ...
    public ResponseEntity<String> deleteCounty(@PathVariable String id) {
        try {
            ...
            return new ResponseEntity<>("Jeg kunne ikke slet id=" + id, HttpStatus.NOT_FOUND);
        }
    }
}
